...
// // 절대 경로 파일
// import TaskContent from "@/src/components/common/ArticleContent";
// import TaskComments from "@/src/components/common/ArticleComments";
...
//   const response = await axiosInstance.get<{ code: number; data: Article }>(
//     `/posts/${taskId}`,
//   );
...
//   const [task, setTask] = useState<Article | null>(null);
