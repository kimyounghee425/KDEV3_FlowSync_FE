...
function SelectMemberBox() {
  ...
  return (
    <SelectRoot collection={frameworks} size="md" width="110px" value={[filter]} onValueChange={handleValueChange}>
      <SelectTrigger>
  ...
  return (
    <Box>
      <Flex gap={4} alignItems="center" justifyContent="end">
        <HStack>
          <SelectMemberBox />
          <Input placeholder="회원명 검색" size="md" value={input} onChange={onChangeSearch} onKeyDown={onKeyDown} width="300px" />
