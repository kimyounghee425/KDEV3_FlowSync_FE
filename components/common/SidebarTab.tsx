...
export default function SidebarTab({ projectStatus }: { projectStatus: string }) {
  const list = Data.filter(Data => (projectStatus === "완료 프로젝트" ? Data.progressStage === "완료" : Data.progressStage === "진행 중"))
    .slice(0, 5)
    .map(item => {
      return (
